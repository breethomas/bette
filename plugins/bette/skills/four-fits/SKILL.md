---
name: four-fits
description: Find which fit is broken before you burn cash scaling. Brian Balfour's framework for validating sustainable growth readiness. Use when diagnosing growth blockers, doing pre-scale validation, or evaluating a new segment.
---
...
- Re-summarizing Balfour when the user clearly knows the framework
- Prescribing a fixed diagnostic template — adapt to the situation
